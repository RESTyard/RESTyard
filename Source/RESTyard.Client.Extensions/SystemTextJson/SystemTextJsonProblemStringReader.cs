...
namespace RESTyard.Client.Extensions.SystemTextJson
{
    public class SystemTextJsonProblemStringReader : IProblemStringReader
    {
        public bool TryReadProblemString(string problemString, [NotNullWhen(true)] out ProblemDetails? problemDescription)
        {
            ...
            try
            {
                problemDescription = JsonSerializer.Deserialize<ProblemDetails>(
                    problemString,
    ...
    /// <summary>
    /// Copy-Paste of Microsoft.AspNetCore.Http.ProblemDetailsJsonConverter because it is marked as internal
    /// </summary>
