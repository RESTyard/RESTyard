...
namespace WebApi.HypermediaExtensions.WebApi.AttributedRoutes
{
    ...
    public class HttpDeleteHypermediaAction : HttpDeleteAttribute, IHaveRouteInfo
    {
        public Type RouteType { get; private set; }
        public Type RouteKeyProducerType { get; private set; }
        /// <summary>
        /// Indicates that this route will accept deletes generated by the corresponding HypermediaAction used in HypermediaObjects.
        ...
        /// </param>
        public HttpDeleteHypermediaAction(Type routeType, Type routeKeyProducerType = null)
        {
        ...
        /// This type will be used to create a n instance of the producer and generate the key object used in a UrlHelper to determine the final URL.
        /// </param>
        public HttpDeleteHypermediaAction(string template, Type routeType, Type routeKeyProducerType = null) : base(template)
        {
            Init(routeType, routeKeyProducerType);
        }
