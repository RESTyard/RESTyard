...
namespace WebApiHypermediaExtensionsCore.WebApi.RouteResolver
{
    public class RouteRegister : IRouteRegister
    {
        ...
        private readonly Dictionary<Type, IRouteKeyProducer> routeKeyProducerRegister;

        public RouteRegister()
        {
            routeRegister  = new Dictionary<Type, string>();
            routeKeyProducerRegister = new Dictionary<Type, IRouteKeyProducer>();
        }
        ...
        public void AddRouteKeyProducer(Type keySourceType, IRouteKeyProducer keyProducer)
        {
        ...
        public IRouteKeyProducer GetKeyProducer(Type type)
        {
            IRouteKeyProducer keyProducer;
